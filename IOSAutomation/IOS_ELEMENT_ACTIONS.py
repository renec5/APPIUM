...
print(f"text on the button alertView: {alertView.text}")
print(f"Getting 'name' attribute information: {alertView.get_attribute('name')}")
print(f"Getting 'type' attribute from alertView button: {alertView.get_attribute('type')}")
