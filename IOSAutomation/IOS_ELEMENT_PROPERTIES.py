...
print("Displayed: {0}".format(alertView.is_displayed()))
print("Enabled: {0}".format(alertView.is_enabled()))
print("Selected: {0}".format(alertView.is_selected()))
print("Size: {0}".format(alertView.size))
print("Location: {0}".format(alertView.location))
print(f"Displayed: {alertView.is_displayed()}")
